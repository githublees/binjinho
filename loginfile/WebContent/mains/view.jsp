						...
						<div class="container">
							...
							<a href="#" class="image featured"><img src="images/pic08.jpg" alt="" /></a>
								...
								<div class="row" id="view">
									...
									<a href="index.jsp#index" class="btn btn-success btn-arraw-left" style="margin:10px;padding:10px 15px 10px 15px;text-align:center;" >목록</a>
									<%
										if(userID != null && userID.equals(bbs.getUserID()) || tag == 1){
									%>
										    <a href="update.jsp?bbsID=<%= bbsID %>#update" class="btn btn-success btn-arraw-left" style="margin:10px;padding:10px 15px 10px 15px;text-align:center;">수정</a>
											<a href="deleteAction.jsp?bbsID=<%= bbsID %>" class="btn btn-success btn-arraw-left" style="margin:10px;padding:10px 15px 10px 15px;text-align:center;">삭제</a>
									<%
										}
									%>
								</div>
