							...
							<a href="#" class="image featured"><img src="images/pic08.jpg" alt="" /></a>
								...
								<form method="post" action="writeAction.jsp">
									<table class="table table-striped" style="text-align: center; border: 1px solid #ddddddd">
										...
										<tbody>
											<tr>
												<td><input type="text" class="form-control" placeholder="글 제목" name="bbsTitle" maxlength="50"; style="align:center;"></td>
											</tr>
											<tr>
												<td><textarea class="form-control" placeholder="글 내용" name="bbsContent" maxlength="2048" style="height: 350px; align:center;"></textarea></td>
											</tr>
										</tbody>
