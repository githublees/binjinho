...
<head>
  ...
  <iframe  src="lol_board_1.html"  scrolling='auto' border='no' maginwidth='0' frameborder='0' style="height:120%; width: 101%">
           </iframe>
							<div id="footer1">
									<div class="slider close">
										<button class="closer" onclick="chat();" style="float:right;" value="닫기"></button>
										<iframe src="http://uchat.ch/jinho_lol" height="450" width="700" style="margin: 20 10 20 300;"></iframe>  
