...
String url = "jdbc:mariadb://localhost:7009/stone";
	...
	try {
		...
		String sqlCount = "SELECT COUNT(*) FROM board_3";
		...
		int sort=1;
		String sqlSort = "SELECT NUM from board_3 order by ref desc, step asc";
		rs = stmt.executeQuery(sqlSort);
	
		
		while(rs.next()){
			int stepNum = rs.getInt(1);
			sql = "UPDATE board_3 SET STEP2=" + sort + " where NUM=" +stepNum;
		...
		String sqlList = "SELECT NUM, USERNAME, TITLE, TIME, HIT, INDENT from board_3 where STEP2 >="+start + " and STEP2 <= "+ end +" order by step2 asc";
...
%>
 <tr height="1" bgcolor="green"><td colspan="6" width="752"></td></tr>
 </table>
